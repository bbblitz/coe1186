/**************************************************/
     How to interface with the Train Controller
/**************************************************/
...
The TrainController class will expect the following methods to be exposed the object of the TrainModel class instance it has a reference to:
